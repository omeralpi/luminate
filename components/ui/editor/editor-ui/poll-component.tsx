...
import type {
  ...
  Options,
  PollNode,
} from "@/components/ui/editor/nodes/poll-node"
import {
  $isPollNode,
  createPollOption,
} from "@/components/ui/editor/nodes/poll-node"
...
export default function PollComponent({
  ...
  return (
    <div
      className={`bg-background max-w-[600px] min-w-[400px] cursor-pointer rounded-lg border border-gray-200 select-none ${isFocused ? "outline-primary outline outline-2" : ""
        }`}
      ref={ref}
    >
